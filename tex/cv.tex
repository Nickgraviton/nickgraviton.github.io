...
%\phone{}
\email{nikolaos.filinis@gmail.com}
...
\cventry{2022--Present}{PhD Candidate}
{\newline \href{https://www.netmode.ntua.gr/}{NETMODE Lab}, National Technical University of Athens}
{\newline Thesis Title: Orchestration of Distributed Applications across the Computing Continuum (IoT-Edge-Cloud)}
...
\cvitem{\textbf{Languages}}{Greek (Native), English(C2), Spanish(C1), German(C1)}
